            ...
            <ul className="list-unstyled d-flex">
              <li className="ms-3">
                <a className="link-body-emphasis" href="/">
                  <i
                    className="fa-brands fa-facebook text-primary-emphasis "
              ...
              <li className="ms-3">
                <a className="link-body-emphasis" href="/">
                  <i
                    className="fa-brands fa-twitter text-primary-emphasis"
                    style={{ fontSize: "1.6rem" }}
                  ></i>
                </a>
              </li>
              <li className="ms-3">
                <a className="link-body-emphasis" href="/">
                  <i
                    className="fa-brands fa-square-instagram text-primary-emphasis"
                    style={{ fontSize: "1.6rem" }}
                  ></i>
                </a>
              </li>
